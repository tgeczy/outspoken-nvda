...
#define SETTING_KEY L"Software\\outSPOKEN SAPI"
#define SETTINGS_FOLDER L"outSPOKEN SAPI"
...
/* Where the two files live: %APPDATA%\outSPOKEN SAPI\settings.toml and
 * %ProgramData%\outSPOKEN SAPI\settings.toml, unless the environment says
 * otherwise (OUTSPOKEN_SAPI_SETTINGS_USER / _MACHINE, read once, for tests). */
