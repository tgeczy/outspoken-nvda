...
#: This repository has one. The Tiger and Leopard copies live in
#: panthera-speech and have the same test there -- the contract below is what
#: keeps the two repositories in step, since neither can see the other.
PLUGINS = [
    os.path.join(ROOT, "addon", "globalPlugins", "outspokenRom.py"),
]
